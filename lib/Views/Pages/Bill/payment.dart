...
class Payment extends StatefulWidget {
  ...
  const Payment({Key? key, required this.lstrDataList, required this.fnCallBack, this.lstrRetailPay, required this.lstrPaymentList}) : super(key: key);
...
class _PaymentState extends State<Payment> {
  ...
  fnDone(){
    ...
    lstrSelectedData [0]["REF"] = txtRefCode.text;
