...
class _PosState extends State<Pos> {
  ...
  void initState() {
    ...
    txtCash.text = '0';
    txtCard.text = '0';
    lstrShifDate = g.wstrClockInDate != null || g.wstrClockInDate != ''
        ? formatDate1.format(DateTime.parse(g.wstrClockInDate.toString()))
        : "";
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.end,
                            children: [
                              th(g.wstrUserName.toString(), Colors.blueGrey,
                                  16),
                              gapW(),
                              tcn(lstrTime ?? '', Colors.blueGrey, 16),
                              gapWC(20),
                              tcn(g.wstrShifDescp.toString().toUpperCase(),
                                  Colors.blueGrey, 16),
                              gapWC(20),
                              GestureDetector(
                                onTap: () {
                              ...
                              Bounce(
                                ...
                                child: Container(
                                  ...
                                  margin: EdgeInsets.symmetric(horizontal: 5),
                                  decoration:
                                      boxBaseDecoration(Colors.amber, 5),
                                  child: Icon(
                                    Icons.print,
                                    color: Colors.black,
                                    size: 15,
                        ...
                        ? Container(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  decoration:
                                      boxBaseDecoration(Colors.white, 0),
                                                          ...
                                                          lstrSplitOption ==
                                                              ...
                                                              ? tcn(
                                                                  (lstrSplitBillQty >
                                                                      ...
                                                                      ? ""
                                                                      : mfnLng(
                                                                          "Quantity split not possible, only have one item.")),
                                                                  Colors.red,
                                                                  10)
                                                              : gapWC(0),
                                                        ],
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    lstrSplitOption ==
                                                                            'EQ'
                                                                        ? tc(
                                                                            lstrSplitBillAmt.toStringAsFixed(
                                                                                2),
                                                                            PrimaryColor,
                                                                            15)
                                                                        : gapHC(
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              gapWC(5),
                                              ts(lstrSelectedUser, Colors.black,
                                                  12),
                                            ],
                                          ),
                                          Row(
                                            children: [
                                              ...
                                              gapWC(5),
                                              ts(lstrSelectedDate, Colors.black,
                                                  12),
                                            ],
                                          ),
                                        ],
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              gapWC(5),
                                              ts(lstrSelectedName, Colors.black,
                                                  12),
                                            ],
                                          ),
                                          Row(
                                      ...
                                      gapHC(10),
                                      (lstrLastDiscount > 0 ||
                                              lstrLastAddlAmount > 0)
                                          ? Row(
                                              mainAxisAlignment:
                                                  MainAxisAlignment
                                                      .spaceBetween,
                                              children: [
                                                tcn(mfnLng('Bill Amount'),
                                                    Colors.black, 15),
                                                tcn(
                                                    ((lstrLastTotal +
                                                                lstrLastDiscount) -
                                      ...
                                      Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                                        children: [
                                          tcn(mfnLng('Taxable Amount'),
                                              Colors.black, 15),
                                          ts(lstrTaxable.toStringAsFixed(3),
                                              Colors.black, 16)
                                        ],
                                      ),
                                      Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                                        children: [
                                          tcn(mfnLng('Vat Amount'),
                                              Colors.black, 15),
                                          ts(lstrLastVat.toStringAsFixed(3),
                                              Colors.black, 16)
                                        ],
                                      ),
                                      GestureDetector(
                                      ...
                                      Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                                        children: [
                                          th(mfnLng('Net Amount').toString(),
                                              Colors.black, 17),
                                          tc(lstrLastTotal.toStringAsFixed(3),
                                              PrimaryColor, 18)
                                        ],
                                      ),
                                      gapHC(5),
                                                  ...
                                                  child: Container(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        lstrPosSelection == "H"
                                                            ? lstrSelectedDocDate ==
                                                                    formatDate.format(DateTime.parse(g
                                                                        .wstrClockInDate
                                                                        .toString()))
                                                                ? GestureDetector(
                                                                    onTap: () {
                        ...
                        : Container(
                            ...
                            child: Center(
                              ...
                              children: [
                                ...
                                gapHC(10),
                                tc(mfnLng('CLOCK-IN NOT VALID'), Colors.black,
                                    30),
                                tcn(mfnLng('LAST CLOCK-IN'), Colors.black, 20),
                                tcn(
                                    formatDate
                                        .format(DateTime.parse(
                                            g.wstrClockInDate.toString()))
                                        .toString(),
                                    Colors.red,
                                    20),
                              ],
      ...
      rtnWidget.add(Container(
        ...
        child: Column(
          children: [
            ...
            g.mfnDbl(e["VAT_PERC"]) > 0
                ? Row(
                    children: [
                      Expanded(
                          child: tcn(
                              "VAT (" +
                                  g.mfnDbl(e["VAT_PERC"]).toString() +
                                  "%" +
                                  ")",
                              Colors.black,
                              12)),
                      gapWC(10),
                      tcn(g.mfnDbl(e["VAT_AMT"]).toString(), Colors.red, 13)
                    ],
                  )
                : gapHC(0),
          ],
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          bottomMenuCard('ADDL', Icons.money, "RE"),
        ],
      ),
    );
  }
        ...
        child: Bounce(
          onPressed: () {
            ...
            if (mode == "ME") {
              ...
              if (g.fnValCheck(lstrSelectedkot)) {
                ...
                showToast(mfnLng('Please Select Order'));
              }
            } else if (mode == "PK") {
              if (g.fnValCheck(lstrSelectedkot)) {
          ...
          child: Container(
            ...
            margin: EdgeInsets.symmetric(
                horizontal: lstrBottomOption == mode ? 10 : 5,
                vertical: lstrBottomOption == mode ? 0 : 2),
            decoration: boxDecoration(
                lstrBottomOption == "mode" ? PrimaryColor : PrimaryColor, 5),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Expanded(
                  child: tcn(
                      mfnLng(title).toString(),
                      lstrBottomOption == "mode" ? Colors.white : Colors.white,
                      10),
                ),
                gapWC(5),
                Icon(
    ...
    return Flexible(
        ...
        child: Bounce(
          ...
          child: Container(
            height: 35,
            decoration: boxBaseDecoration(
                lstrSplitOption == mode ? PrimaryColor : greyLight, 5),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                tc(mfnLng(title.toString()),
                    lstrSplitOption == mode ? Colors.white : Colors.black, 12)
              ],
            ),
          ),
        ));
                          ...
                          children: [
                            Container(
                              ...
                              child: Checkbox(
                                  ...
                                  value:
                                      lstrSelectedSplitItem.contains(dataList),
                                  onChanged: (value) {
                                    print(value);
                            ...
                            Expanded(
                              child: tcn((srno).toString() + '. ' + itemName,
                                  Colors.black, 13),
                            ),
                            Container(
                              width: 50,
                              child: th('x ' + itemQty.toStringAsFixed(2),
                                  Colors.black, 12),
                            ),
                          ],
                        ),
        ...
        mobile: GridView.builder(
            ...
            itemBuilder: (BuildContext ctx, index) {
              ...
              if (g.fnValCheck(kot)) {
                ...
                lstrDeliveryRef =
                    lstrOrderRoom.toString() + ' ' + lstrDeliveryRef.toString();
              }
  ...
  GestureDetector orderCardView(
      dataList,
      String lstrOrderNo,
      String lstrOrderType,
      String lstrTableNo,
      String lstrNetAmount,
      String lstrCreateUser,
      String lstrCustomerName,
      String lstrCustomerMob,
      String lstrDeliveryMode,
      String lstrDeliveryRef,
      String mergeDocno,
      String splitDocno) {

    var splitColor = blueLight;
    if(splitDocno.isNotEmpty){
      splitColor =  fnGenerateColor(splitDocno);
    }
    ...
    return GestureDetector(
      ...
      child: ClipPath(
        ...
        child: Container(
          padding: EdgeInsets.all(10),
          decoration: lstrBottomOption == "ME"
              ? boxDecoration(
                  lstrMergeKotDocno.contains(lstrOrderNo)
                      ? yellowLight
                      : Colors.white,
                  5)
              : boxDecoration(
                  lstrSelectedDocno == lstrOrderNo ? yellowLight : splitDocno != ""? (splitColor??blueLight).withOpacity(0.2) : Colors.white,
                  5),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      tc(mfnLng('Order').toString() + " " + lstrOrderNo,
                          Colors.black, 15),
                    ],
                  ),
                  gapHC(5),
                      ...
                      mergeDocno != ""
                          ? Row(
                              children: [
                                ...
                                gapWC(5),
                                tc(mfnLng('MERGE'), Colors.blue, 12)
                                // BlinkText(
                                //   'MERGE',
  ...
  List<Widget> rslViewNew() {
    List<Widget> rtnList = [];
    rtnList.add(Row());
    for (var e in listRslBills) {
      var dataList = e;
      var rsl = dataList['RSL'];
    ...
    return GestureDetector(
      ...
      child: ClipPath(
        ...
        child: Container(
            ...
            padding: EdgeInsets.all(10),
            decoration: boxDecoration(
                lstrSelectedDocno == rslDocNo ? blueLight : Colors.white, 5),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    th(mfnLng('Order') + rslDocNo, Colors.black, 13),
                    tc(
                        lstrRslType == 'T'
                            ? 'Table   ' + lstrTableNo
                            : lstrRslType == 'A'
                ...
                Row(
                  children: [
                    ...
                    gapWC(5),
                    Expanded(child: ts(lstrCreateDate, Colors.black, 11)),
                  ],
                ),
                Row(
                  children: [
                ...
                GestureDetector(
                  onTap: () {
                    setState(() {
                      printHead = dataList['RSL'];
                      printDet = dataList['RSLDET'];
  ...
  Widget itemView(snapshot) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          var itemCode = dataList['STKCODE'];
          var itemName = dataList['STKDESCP'];
          var lngName = (dataList['REF2'] ?? "");
          var itemQty = g.mfnDbl(dataList['QTY1']);
          var itemStatus = dataList['STATUS'].toString();
          var itemRate = g.mfnDbl(dataList['RATE'].toString());
          var discAmt = g.mfnDbl(dataList['DISC_AMT'].toString());
          var discCode = dataList['DISC_CODE'] ?? "";
          var discDescp = dataList['DISC_DESCP'] ?? "";
          var addonYn = dataList['ADDON_STKCODE'] ?? "";

          var addonItems = [];
          addonItems = lstrSelectedkotDet
              .where((element) => element["ADDON_STKCODE"] == itemCode)
              .toList();

          var itemTotal = (itemQty * itemRate) - discAmt;
          itemTotal = itemTotal + fnGetAddonItemRate(addonItems);
          if (itemStatus != 'C') {
            srno = srno + 1;
          }
                              ...
                              Row(
                                ...
                                children: [
                                  lstrDiscountScreen &&
                                          ...
                                          lstrDiscountItems.contains(itemCode)
                                      ? Container(
                                          //DISCOUNT##
                                          child: Checkbox(
                                              activeColor: Colors.green,
                                              value: lstrSelectedItemDisc
                                                  .contains(itemCode),
                                              onChanged: (value) {
                                                print(value);
                                                fnItemWiseDiscSelect(
                                                    itemCode, value);
                                              }),
                                        )
                                      : Container(),
                                  ...
                                  Container(
                                    width: 60,
                                    child: th(itemRate.toStringAsFixed(2),
                                        Colors.black, 12),
                                  ),
                                  Container(
                                    width: 50,
                                  ...
                                  Container(
                                      ...
                                      child: Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.end,
                                        children: [
                                          th(itemTotal.toStringAsFixed(1),
                                              PrimaryColor, 13),
                                        ],
                                      )),
                                  // Row(
                              ...
                              discAmt > 0
                                  ? Row(
                                      children: [
                                        ...
                                        gapWC(5),
                                        tcn(discDescp.toString(), Colors.black,
                                            12)
                                      ],
                                    )
                                  : gapHC(0),
                              Column(
                                children: wAddonList(addonItems),
                              )
                            ],
                          )),
                )
  ...
  List<Widget> wAddonList(addonList) {
    List<Widget> rtnList = [];
    rtnList.add(Row(
      children: [
        tcn('Addon', Colors.black, 10),
      ],
    ));
    for (var e in addonList) {
      var itemCode = e['STKCODE'];
      var itemName = e['STKDESCP'];
      var itemQty = g.mfnDbl(e['QTY1']);
      var itemRate = e['RATE'].toString();
          ...
          Row(
            ...
            children: [
              lstrDiscountScreen &&
                  ...
                  : Container(),
              Expanded(
                child: tcn("*" + itemName, Colors.black, 12),
              ),
              Container(
                width: 60,
                child: tcn(double.parse(itemRate).toStringAsFixed(2),
                    Colors.black, 12),
              ),
              Container(
                width: 50,
                child: tcn('x ' + itemQty.toStringAsFixed(2), Colors.black, 12),
              ),
              Container(
                  width: 60,
                  child: Row(
                    ...
                    children: [
                      tcn(itemTotal.toStringAsFixed(1), Colors.white, 12),
                    ],
                  )),
            ],
          ),
  ...
  Widget rslItemView() {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          var voidAmount = g.mfnDbl(dataList['VOID_QTY'].toString()) *
              g.mfnDbl(dataList['RATE'].toString());
          return GestureDetector(
            onTap: () {},
            child: itemStatus == 'C'
                ? Container()
                : Container(
                    ...
                    margin: EdgeInsets.only(bottom: 5),
                    decoration: boxBaseDecoration(
                        returnSts == "Y" ? Colors.red : greyLight, 3),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Expanded(
                          child: th(
                              ...
                              returnSts == "Y" ? Colors.white : Colors.black,
                              12),
                        ),
                        Row(
                          children: [
                            Container(
                              width: 60,
                              child: th(
                                  double.parse(itemRate).toStringAsFixed(2),
                                  returnSts == "Y"
                                      ? Colors.white
                                      : Colors.black,
                                  12),
                            ...
                            Container(
                              ...
                              child: th(
                                  'x ' +
                                      double.parse(itemQty).toStringAsFixed(0),
                                  returnSts == "Y"
                                      ? Colors.white
                                      : Colors.black,
                                  12),
  ...
  Widget discountCard(size, title, mode) {
    return Bounce(
        child: Container(
          ...
          decoration: boxDecoration(
              lstrSelectedDiscount == mode ? Colors.amber : Colors.white, 5),
          child: Center(
            child: tcn(mfnLng(title), Colors.black, 15),
          ),
        ),
        duration: Duration(milliseconds: 110),
        onPressed: () {
  ...
  fnPayPopup() {
    if (lstrSelectedDocno.isEmpty) {
      showToast(mfnLng('Please choose order'));
      return;
    }
    //fnSave();
  ...
  //COLOR#
  fnGenerateColor(docno){
    Color tempcol;
    var docList = lSplitColors.where((e) => e["DOCNO"] == docno).toList();
    if(docList.isEmpty){
  ...
  fnSaveMergeKot() {
    ...
    if (lstrMergeKotDocno.length < 2) {
      showToast(mfnLng('Please Select Orders'));
      return;
    }
  ...
  fnSplitBillQuantity() {
    if (lstrSplitBillQty < 1) {
      showToast(mfnLng('QTY 1,Quantity wise split not possible'));
    }
  }
  ...
  fnSplitAddOldToNew() {
    setState(() {
      if (lstrSplitQtyBill == "") {
        showToast(mfnLng('Please select slip#'));
      } else {
        if (lstrSelectedSplitItem.length > 0) {
          ...
          showToast(mfnLng('Please select items'));
        }
      }
    });
  }
  ...
  fnSaveSplitKot() {
    ...
    if (lstrSplitOption == "EQ") {
      ...
      if (lstrOldSplitBill.isNotEmpty) {
        showToast(mfnLng('Please split all items'));
        return;
      }
      for (var e in lstrSplitBills) {
        var selectedData = [];
  ...
  fnOrderClick(dataList, code) {
    ...
    if (lstrCreateDate != "") {
      ...
      lstrCreateDate =
          formatTime.format(DateTime.parse(lstrCreateDate)).toString();
    ...
    lstrSelectedType = lstrOrderType == 'T'
        ? 'Table  ' + lstrTableNo
        : lstrOrderType == 'A'
            ? 'Takeaway'
            : lstrOrderType == 'D'
                ...
                : '';
    lstrDeliveryMode =
        (kot[0]["ORDER_MODE"] ?? "") + ' - ' + (kot[0]["ORDER_MODE"] ?? "");
    lstrPaymentList = [];
  ...
  fnRslClick(dataList, code) {
    ...
    setState(() {
      ...
      lstrSelectedUser = lstrCreateUser ?? '';
      lstrSelectedName = (rsl[0]["ORDER_MODE"] ?? "").toString() +
          "  " +
          (rsl[0]["REF6"] ?? "").toString();
      ;
      ...
      lstrSelectedDocDate = formatDate
          .format(DateTime.parse(rsl[0]["DOCDATE"].toString()))
          .toString();
      lstrSelectedDate = formatTime
          .format(DateTime.parse(rsl[0]["CREATE_DATE"].toString()))
          .toString();
    });
  }
  ...
  fnOrderCalc(lastOrder) {
    ...
    if (g.fnValCheck(lastOrder)) {
      ...
      var oTotalAmount = 0.0;
      var oVatAmount = 0.0;
      var oOtherVatAmount = 0.0;
          ...
          if (qty > 0) {
            ...
            if (itemTotalTaxPerc > 0) {
              if (vatSts == 'Y') {
                ...
                oTotalAmount = oTotalAmount + total;
              } else {
                itemTaxable = total;
                vat = (vatP) / 100;
            ...
            oVatAmount = oVatAmount + itemVatAmount;
            oOtherVatAmount = oOtherVatAmount + itemOtherVatAmount;
            totalQty = totalQty + qty;

            print("**********************************************************");
            print("TOTAL" + oTotalAmount.toString());
            print("TOTAL TAX PERC" + itemTotalTaxPerc.toString());
            print("CONVERSION FACTOR" + itemConversionFactor.toString());
            print("TAXABLE" + oTaxableAmount.toString());
            print("VAT " + oVatAmount.toString());
            print("OTHER VAT " + oOtherVatAmount.toString());
            print("**********************************************************");
          }
        }
      }
      ...
      setState(() {
        lstrLastOtherAmount = oOtherVatAmount;
        lstrLastTotal = oTotalAmount + lstrLastAddlAmount;
        lstrLastGross = grossAmount;
        lstrTaxable = oTaxableAmount;
        lstrLastVat = oVatAmount;
        if (g.fnValCheck(lstrSelectedBill)) {
          lstrSelectedBill[0]["TOTAL_AMT"] = oTotalAmount + lstrLastAddlAmount;
        }
      });
    } else {
      setState(() {
  ...
  fnGetAddonItemRate(addonList) {
    var rate = 0.0;
    for (var e in addonList) {
      var itemQty = g.mfnDbl(e['QTY1']);
      var itemRate = g.mfnDbl(e['RATE'].toString());
      rate = rate + (itemRate * itemQty);
    }
    return rate;
  }
  ...
  fnSave() {
    ...
    if (g.fnValCheck(lstrSelectedBill)) {
      ...
      showToast(mfnLng('Please select payment mode'));
      return;
    }
    ...
    if (lstrPaidAmt < lstrLastTotal && lstrPaymentList[0]["MODE"] != "CREDIT") {
      showToast(mfnLng('Please check your amount'));
      return;
    }
    ...
    if (lstrPaymentList[0]["MODE"] == "CREDIT" && lstrPartyCode == "") {
      showToast(mfnLng('Please Select Party'));
      return;
    }
    setState(() {
      saveSts = false;
    ...
    if (g.fnValCheck(lstrSelectedkotDet)) {
        ...
        if (sts != 'C') {
          ...
          if (qty > 0) {
            ...
            lstrRslDet.add({
              ...
              "DISC_AMT":
                  g.mfnDbl(e["DISC_AMT"].toString()) * g.wstrCurrencyRate,
              "DISC_AMTFC": g.mfnDbl(e["DISC_AMTFC"].toString()),
              ...
              "ADDL_AMT": headerAddlAmount * g.wstrCurrencyRate,
              "ADDL_AMTFC": headerAddlAmount,
              "AC_AMT": "",
              "AC_AMTFC": "",
              "PRVDOCTABLE": "KOT",
              ...
              "LASTCOSTFC": "",
              "HEADER_DISC_AMT":
                  double.parse(headerDiscount.toStringAsFixed(5)) *
                      g.wstrCurrencyRate,
              "HEADER_DISC_AMTFC":
                  double.parse(headerDiscount.toStringAsFixed(5)),
              "HEADER_GIFT_VOUCHER_AMT": "",
              "HEADER_GIFT_VOUCHER_AMTFC": "",
              "TOT_TAX_AMT": double.parse(itemVatAmount.toStringAsFixed(5)) *
                  g.wstrCurrencyRate,
              "TOT_TAX_AMTFC": double.parse(itemVatAmount.toStringAsFixed(5)),
              "GIFT_VOUCHER_NO": "",
              "GIFT_VOUCHER_AMT": "",
              "GIFT_VOUCHER_AMTFC": "",
              ...
              "ADVANCE_AMTFC": "",
              "ADVANCE_AMT": "",
              "TAXABLE_AMT": double.parse(itemTaxable.toStringAsFixed(3)) *
                  g.wstrCurrencyRate,
              "TAXABLE_AMTFC": double.parse(itemTaxable.toStringAsFixed(3)),
              "ORDER_TYPE": lstrSelectedOrderType,
              "TOTAL_TAX_PERC":
                  double.parse(itemTotalTaxPerc.toStringAsFixed(3)),
              "OTHER_TAX_AMT":
                  double.parse(itemOtherVatAmount.toStringAsFixed(3)) *
                      g.wstrCurrencyRate,
              "OTHER_TAX_AMTFC":
                  double.parse(itemOtherVatAmount.toStringAsFixed(3)),
            });
      ...
      setState(() {
        lstrLastTotal = double.parse(oTotalAmount.toStringAsFixed(3));
        lstrLastGross = double.parse(grossAmount.toStringAsFixed(3));
        lstrTaxable = double.parse(oTaxableAmount.toStringAsFixed(3));
        lstrLastVat = double.parse(oVatAmount.toStringAsFixed(3));
        lstrLastOtherAmount = double.parse(oOtherVatAmount.toStringAsFixed(3));
    ...
    lstrRsl.add({
      ...
      "PAID_AMT":
          double.parse(lstrPaidAmt.toStringAsFixed(5)) * g.wstrCurrencyRate,
      "PAID_AMTFC": double.parse(lstrPaidAmt.toStringAsFixed(5)),
      "BAL_AMT":
          double.parse(lstrBalanceAmt.toStringAsFixed(5)) * g.wstrCurrencyRate,
      ...
      "DOCUMENT_STATUS": "",
      "TAX_AMT":
          double.parse(lstrLastVat.toStringAsFixed(5)) * g.wstrCurrencyRate,
      "TAX_AMTFC": double.parse(lstrLastVat.toStringAsFixed(5)),
      "TAXABLE_AMT":
          double.parse(lstrTaxable.toStringAsFixed(5)) * g.wstrCurrencyRate,
  ...
  fnDiscountCallBack(amount) {
    ...
    fnUpdateKotDiscount(
        lstrSelectedDocno, lstrSelectedDocType, lstrLastDiscount);
  }
    ...
    setState(() {
      ...
      if (g.fnValCheck(lstrAppliedDisc)) {
        for (var e in lstrAppliedDisc) {
          var code = e;
          var descp = '';
          var itemList = g.fnValCheck(lstrSelectedItemDisc)
              ? lstrSelectedItemDisc
              : lstrDiscountItems;
  ...
  fnClockOut() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => ShiftClosing()));
  }
  ...
  fnAddlCallBack(addlList, amount, addlDataList) {
    ...
    fnUpdateKotAddl(lstrSelectedDocno, lstrSelectedDocType, lstrLastAddlAmount,
        lstrAddlAmount);
  }

  fnReports() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => ReportViewer()));
  }

  fnSysytemInfo() {
    var checkDate = DateTime.parse(formatDate2
        .format(DateTime.parse(g.wstrClockInDate).add(Duration(days: 1))));
    //var checkDate = DateTime.parse(formatDate2.format(DateTime.parse(g.wstrClockInDate)));
    var checkDateTime = DateTime(checkDate.year, checkDate.month, checkDate.day,
        g.wstrAutoClockOutTime, 0, 0);
            ...
            children: [
              Row(
                children: [
                  ...
                  tc(
                      formatDate2
                          .format(DateTime.parse(g.wstrClockInDate))
                          .toString(),
                      Colors.black,
                      20)
                ],
              ...
              //     gapWC(10),
              //     tc(lstrToday.toString(),Colors.black,20)
              //   ],
              // ),
              // Row(
              //   children: [
              //     Icon(Icons.access_time,size: 20,color: Colors.black,),
              //     gapWC(10),
              //     tc(rtnSts.toString(),Colors.black,20)
              //   ],
              // ),
              // Row(
              //   children: [
              //     Icon(Icons.access_time,size: 20,color: Colors.black,),
              //     gapWC(10),
              //     tc(checkDateTime.toString(),Colors.black,20)
              //   ],
              // ),
              Row(
                children: [
  ...
  fnSalesSummary() {
    if (g.wstrRoleCode == "QADMIN" || g.wstrRoleCode == "ADMIN") {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => SalesSummary()));
    } else {
      // showToast( 'Contact your admin!!');
      PageDialog()
          .show_(context, OpenDrawer(fnCallBack: fnSalesSummarySuccess), '');
    }
  }
  ...
  fnSalesSummarySuccess(data, user) {
    if (data == '1') {
      ...
      showToast(mfnLng('PERMISSION DENIED'));
    }
  }
  ...
  fnSaveMerge(kot, kotDet, passcode, kotChoice, kotMerge) async {
    futureOrder = apiCall.SaveMergeOrder(
        kot, kotDet, "ADD", passcode, kotChoice, kotMerge);
  ...
  //SPLIT#
  fnSaveSplit(orders) {
    futureOrder = apiCall.SaveSplitOrder(
        g.wstrCompany,
        g.wstrYearcode,
        lstrSelectedDocno,
        lstrSelectedDocType,
  ...
  fnGetOrders(type, tablenNo, mode) async {
    futureOrders = apiCall.getKotInvoices(g.wstrCompany, g.wstrYearcode, null,
        type, tablenNo, mode, txtKotSearch.text);
    futureOrders.then((value) => fnGetOrderSuccess(value));
  }

  fnGetOrderSuccess(value) {}
  fnGetOrderDetails(code) async {
    futureOrderDet = apiCall.getKotInvoiceDet(
        g.wstrCompany, g.wstrYearcode, code, null, null, "", "");
  ...
  fnSaveInvoice(otherAmt) async {
    ...
    futureOrderSave = apiCall.saveInvoice(
        lstrRsl,
        lstrRslDet,
        lstrRslVoid,
        lstrRslVoidDet,
  ...
  fnPrintKot() async {
    ...
    if (printKot) {
      ...
      if (mounted) {
        setState(() {
          printHead = lstrSelectedkot;
          printDet = lstrSelectedkotDet;
        });
      }
      fnPrintKotBill();

      futurePrintKot = apiCall.printOrder(g.wstrCompany, lstrPrintKotDocno,
          lstrPrintKotDoctype, lstrPrintKotYearcode, 1, g.wstrPrinterPath);
  ...
  fnPrint() async {
    if (printRsl) {
      ...
      futurePrint = apiCall.printInvoice(g.wstrCompany, g.wstrYearcode,
          lstrPrintDocno, "RSL", 1, g.wstrPrinterPath, lstrPayMode);
  ...
  fnPrintHistory() async {
    if (printRslHistory) {
      ...
      futurePrint = apiCall.printInvoice(g.wstrCompany, g.wstrYearcode,
          lstrPrintDocno, "RSL", 1, g.wstrPrinterPath, "");
  ...
  fnAdminPermission() {
    if (g.wstrRoleCode == "QADMIN" || g.wstrRoleCode == "ADMIN") {
      ...
      fnSaveInvoiceReturn(returnRsl, returnRslDet, returnRetailPay,
          returnRslVoidHistory, returnRslVoidHistoryDet, returnOtherAmount);
    } else {
      // showToast( 'Contact your admin!!');
      PageDialog()
          .show_(context, OpenDrawer(fnCallBack: fnAdminPermissionSuccess), '');
    }
  }
  ...
  fnAdminPermissionSuccess(data, user) {
    if (data == '1') {
      ...
      showToast(mfnLng('PLEASE CONTACT YOUR ADMIN!'));
    }
  }

  fnSaveInvoiceReturn(
      rsl, rsldet, retailpay, history, historyDet, otherAmount) {
    if (saveSts) {
      setState(() {
        saveSts = false;
      });
      futureOrderSave = apiCall.saveInvoiceVoid(
          rsl,
          rsldet,
          [],
          [],
  ...
  //Discount api
  fnGetDiscountList() {
    futureDiscount = apiCall.getDiscountList(
        lstrSelectedDocno, lstrSelectedDocType, g.wstrCompany, g.wstrYearcode);
      ...
      if (sts != 'C') {
        ...
        if (qty > 0) {
          ...
          kotDet.add({
            ...
            "DISC_AMTFC":
                g.mfnDbl(e["DISC_AMTFC"].toString()) * g.wstrCurrencyRate,
            "DISC_CODE": e["DISC_CODE"],
            "DISC_DESCP": e["DISC_DESCP"],
            ...
            "TAX_AMTFC":
                double.parse(vatA.toStringAsFixed(5)) * g.wstrCurrencyRate,
            "TAXINCLUDE_YN": e["TAXINCLUDE_YN"],
            "TAXABLE_AMT": double.parse(taxableAmt.toStringAsFixed(3)),
            "TAXABLE_AMTFC":
                double.parse(taxableAmt.toStringAsFixed(3)) * g.wstrCurrencyRate
          });
        }
      }
    }

    futureDiscount = apiCall.updateKotDiscount(
        g.wstrCompany, g.wstrYearcode, docno, doctype, discAmt, kotDet);
  ...
  fnUpdateKotAddl(docno, doctype, discAmt, addlList) {
      ...
      if (sts != 'C') {
        ...
        if (qty > 0) {
          ...
          kotDet.add({
            ...
            "SRNO": e["SRNO"],
            "HEADER_DISC_AMT":
                double.parse(headerAddlAmount.toStringAsFixed(5)),
            "HEADER_DISC_AMTFC":
                double.parse(headerAddlAmount.toStringAsFixed(5)) *
                    g.wstrCurrencyRate,
          });
    ...
    futureDiscount = apiCall.updateKotAddl(g.wstrCompany, g.wstrYearcode, docno,
        doctype, discAmt, kotDet, addlList);
  ...
  fnCheckDocDate() {
    ...
    if (g.wstrClockInDate != null) {
      var checkDate = DateTime.parse(formatClockDate
          .format(DateTime.parse(g.wstrClockInDate).add(Duration(days: 1))));
      //var checkDate = DateTime.parse(formatDate2.format(DateTime.parse(g.wstrClockInDate)));
      var checkDateTime =
          DateTime(checkDate.year, checkDate.month, checkDate.day, 4, 0, 0);
      var now = DateTime.now();
  ...
  Future fnPrintRslBill() async {
    ...
    if (g.fnValCheck(printHead)) {
      totalExVat = g.mfnDbl(printHead[0]["TAXABLE_AMT"]);
      discount = g.mfnDbl(printHead[0]["DISC_AMT"]);
      totalTax = g.mfnDbl(printHead[0]["TAX_AMT"]);
      netTotal = g.mfnDbl(printHead[0]["NETAMT"]);
    }
    ...
    if (g.fnValCheck(g.wstrCompanyDet)) {
      companyName = (g.wstrCompanyDet[0]["NAME"]).toString();
      ;
      add1 = (g.wstrCompanyDet[0]["ADD1"]).toString();
      ;
      add2 = (g.wstrCompanyDet[0]["ADD2"]).toString();
      ;
      mob = (g.wstrCompanyDet[0]["MOBILE"]).toString();
      ;
      vatin = (g.wstrCompanyDet[0]["VAT_TIN"]).toString();
      ;
    }
    ...
    if (add1.isNotEmpty) {
      bytes += generator.text(add1, styles: PosStyles(align: PosAlign.center));
    }
    if (add2.isNotEmpty) {
      bytes += generator.text(add2, styles: PosStyles(align: PosAlign.center));
    }
    if (mob.isNotEmpty) {
      bytes += generator.text('Tel: $mob',
          styles: PosStyles(align: PosAlign.center));
    }
    if (vatin.isNotEmpty) {
      bytes += generator.text(vatin,
    ...
    Uint8List aTaxInv = await convertArabic('فاتورة ضريبية');
    bytes += generator.textEncoded(aTaxInv,
        styles: PosStyles(
          align: PosAlign.center,
          bold: true,
          height: PosTextSize.size1,
    ...
    for (var e in printDet) {
      ...
      var rateText = rate == 0 ? "" : rate.toStringAsFixed(2);
      var lngName = (e["REF2"] ?? "").toString();
      ...
      var addonItems = [];
      addonItems = printDet
          .where((element) => element["ADDON_STKCODE"] == stkCode)
          .toList();

      var total = (itemQty * itemRate) - discAmt;
      total = total + fnGetAddonItemRate(addonItems);

      noOfItems = noOfItems + qty;

      if (addonStkCode.isEmpty) {
        bytes += generator.row([
          PosColumn(text: stkDescp, width: 7),
          PosColumn(text: qty.toStringAsFixed(0), width: 1),
          PosColumn(
              text: rateText,
              width: 2,
        ...
        if (lngName.toString().isNotEmpty) {
          Uint8List alngName = await convertArabic(lngName);
          bytes += generator.row([
            PosColumn(textEncoded: alngName, width: 7),
            PosColumn(
              text: "",
              width: 1,
            ),
      ...
      for (var k in addonItems) {
        ...
        var Arate = g.mfnDbl(k["RATE"].toString());
        bytes += generator.row([
          PosColumn(
            text: "",
            width: 1,
          ),
          PosColumn(text: "$AstkDescp x ${Aqty.toStringAsFixed(0)}", width: 7),
          PosColumn(
              text: Arate.toStringAsFixed(2),
              width: 2,
              styles: PosStyles(align: PosAlign.right)),
          PosColumn(
              text: "", width: 2, styles: PosStyles(align: PosAlign.right)),
    ...
    bytes += generator.row([
      PosColumn(
          text: 'No.Of Item(s):', width: 6, styles: PosStyles(bold: true)),
      PosColumn(
          text: noOfItems.toStringAsFixed(0),
          width: 6,
          styles: PosStyles(bold: true, align: PosAlign.right)),
    ]);
    Uint8List aNof = await convertArabic('عدد الأصناف');
    bytes += generator.row([
      PosColumn(textEncoded: aNof, width: 6, styles: PosStyles(bold: true)),
      PosColumn(
          text: "",
          width: 6,
          styles: PosStyles(bold: true, align: PosAlign.right)),
    ...
    bytes += generator.row([
      PosColumn(text: 'Total Ex.Vat:', width: 6, styles: PosStyles(bold: true)),
      PosColumn(
          text: totalExVat.toStringAsFixed(2),
          width: 6,
          styles: PosStyles(bold: true, align: PosAlign.right)),
    ]);
    Uint8List aToEx = await convertArabic('لا تشمل الضرائب');
    bytes += generator.row([
      PosColumn(textEncoded: aToEx, width: 6, styles: PosStyles(bold: true)),
      PosColumn(
          text: "",
          width: 6,
          styles: PosStyles(bold: true, align: PosAlign.right)),
    ...
    Uint8List aDiscount = await convertArabic('تخفيض');
    bytes += generator.row([
      PosColumn(
          textEncoded: aDiscount, width: 6, styles: PosStyles(bold: true)),
      PosColumn(
          text: "",
          width: 6,
          styles: PosStyles(bold: true, align: PosAlign.right)),
    ...
    bytes += generator.row([
      PosColumn(text: 'Total Tax', width: 6, styles: PosStyles(bold: true)),
      PosColumn(
          text: totalTax.toStringAsFixed(2),
          width: 6,
          styles: PosStyles(bold: true, align: PosAlign.right)),
    ]);
    Uint8List aTax = await convertArabic("مجموع الضريبة");
    bytes += generator.row([
      PosColumn(textEncoded: aTax, width: 6, styles: PosStyles(bold: true)),
      PosColumn(
          text: "",
          width: 6,
          styles: PosStyles(bold: true, align: PosAlign.right)),
    ...
    bytes += generator.row([
      PosColumn(text: 'Net Total', width: 6, styles: PosStyles(bold: true)),
      PosColumn(
          text: netTotal.toStringAsFixed(2),
          width: 6,
          styles: PosStyles(bold: true, align: PosAlign.right)),
    ]);
    Uint8List aNet = await convertArabic("صافي الإجمالي");
    bytes += generator.row([
      PosColumn(textEncoded: aNet, width: 6, styles: PosStyles(bold: true)),
      PosColumn(
          text: "",
          width: 6,
          styles: PosStyles(bold: true, align: PosAlign.right)),
  ...
  Future fnPrintKotBill() async {
    ...
    Uint8List aTaxInv = await convertArabic('فاتورة ما قبل السداد');
    bytes += generator.textEncoded(aTaxInv,
        styles: PosStyles(
          align: PosAlign.center,
          bold: true,
  ...
  void _printEscPos(List<int> bytes, Generator generator) async {
    ...
    var ip = g.wstrPrinterPath.toString();
  ...
  Future<dynamic> convertArabic(lngName) async {
    Uint8List encArabic ;
    //encArabic = Uint8List.fromList(encArabic.reversed.toList());
    return '';
  }
}
