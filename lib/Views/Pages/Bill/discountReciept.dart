...
class DiscountReceipt extends StatefulWidget {

  final double  oldValue;
  final List<dynamic>  lstrDataList;
  final Function  fnCallBack;

  const DiscountReceipt({Key? key,  required this.fnCallBack, required this.oldValue, required this.lstrDataList}) : super(key: key);

  @override
  _DiscountState createState() => _DiscountState();
}

class _DiscountState extends State<DiscountReceipt> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child:  tc('${mfnLng("BILL AMOUNT")}   '+ lstrLastTotal.toStringAsFixed(3),Colors.red,20),
                      ),
                    ),
                    gapHC(10),
                    Column(
