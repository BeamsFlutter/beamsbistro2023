...
class _PosState extends State<Pos> {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                gapWC(5),
                                th('Closed Checks', Colors.black, 13),
                              ],
                            ),
                            gapHC(5),
                            line(),
                              ...
                              child:   Container(
                                ...
                                child: Center(
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Icon(Icons.breakfast_dining,color: Colors.white,size: 16,),
                                      tc("Quick Order",Colors.white,15)
                                    ],
                                  ),
                                ),
                              ),
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Expanded(child: tcn("VAT ("+g.mfnDbl(e["VAT_PERC"]).toString() + "%" +")", Colors.black, 12)),
                  gapWC(10),
  ...
  Widget rslView(snapshot){
    return ResponsiveWidget(
        ...
        itemBuilder: (BuildContext ctx, index) {
          ...
          return rslCardView(dataList, rslDocNo, lstrRslType, lstrTableNo, lstrNetAmount, lstrCreateUser,lstrRoomRef,lstrOrderRef,lstrCreateDate);
        }),
        tab: GridView.builder(
        gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
  ...
  List<Widget> rslViewNew(){
    ...
    for(var e in listRslBills){
      ...
      rtnList.add(rslCardView(dataList,rslDocNo, lstrRslType, lstrTableNo, lstrNetAmount, lstrCreateUser,lstrRoomRef,lstrOrderRef,lstrCreateDate));
    }
    return rtnList;
  }
  GestureDetector rslCardView(dataList,String rslDocNo, String lstrRslType, String lstrTableNo, String lstrNetAmount, String lstrCreateUser,String orderMode,String orderRef,lstrCreateDate) {
    return GestureDetector(
      onTap: (){
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      th('Order ' +  rslDocNo,Colors.black,13),
                      tc(lstrRslType == 'T' ?'Table   ' + lstrTableNo : lstrRslType == 'A' ? 'Takeaway' : lstrRslType == 'D' ? 'Delivery ' : '',PrimaryColor,13),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Icon(Icons.print,color: Colors.black,size: 18,),
                      ),
                    ),
                  )
  ...
  fnSaveSplitKot(){
    ...
    if(lstrSplitOption == "EQ"){
      ...
      if(lstrOldSplitBill.isNotEmpty){
        showToast('Please split all items');
        return;
      }
      for(var e in lstrSplitBills){
          ...
          if(qty > 0){
            ...
            if(itemTotalTaxPerc > 0){
              if(vatSts == 'Y' ){
                ...
                oTotalAmount =oTotalAmount +itemTaxable + itemVatAmount+ itemOtherVatAmount;
              }
            }
        ...
        if(sts != 'C'){
          ...
          if(qty > 0){
            ...
            lstrRslDet.add({
              ...
              "DISC_AMT":g.mfnDbl(e["DISC_AMT"].toString()) * g.wstrCurrencyRate,
              ...
              "LASTCOST":"",
              "LASTCOSTFC":"",
              "HEADER_DISC_AMT": double.parse(headerDiscount.toStringAsFixed(5)) * g.wstrCurrencyRate,
              "HEADER_DISC_AMTFC":double.parse(headerDiscount.toStringAsFixed(5)) ,
              "HEADER_GIFT_VOUCHER_AMT":"",
              "HEADER_GIFT_VOUCHER_AMTFC":"",
              "TOT_TAX_AMT": double.parse(itemVatAmount.toStringAsFixed(5)) * g.wstrCurrencyRate ,
              ...
              "ADVANCE_AMTFC":"",
              "ADVANCE_AMT":"",
              "TAXABLE_AMT":  double.parse(itemTaxable.toStringAsFixed(3)) * g.wstrCurrencyRate ,
              "TAXABLE_AMTFC":double.parse(itemTaxable.toStringAsFixed(3)) ,
              "ORDER_TYPE":lstrSelectedOrderType,
              "TOTAL_TAX_PERC":  double.parse(itemTotalTaxPerc.toStringAsFixed(3))  ,
              "OTHER_TAX_AMT":double.parse(itemOtherVatAmount.toStringAsFixed(3)) * g.wstrCurrencyRate,
              "OTHER_TAX_AMTFC":double.parse(itemOtherVatAmount.toStringAsFixed(3)),
  ...
  fnGetRsl(code,type,dateFrom,dateTo,mode) async{
    futureRsl=  apiCall.getInvoice(g.wstrCompany,g.wstrYearcode,code,type,dateFrom,dateTo,'','','',txtRslSearch.text.toString(),mode,pageNumber);
